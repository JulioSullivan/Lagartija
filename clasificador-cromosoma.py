...
inputfa = 'Archivos-Join100/joinP3.fa'
out_model = 'Modelos-Entrenados-SVM/trained_model_joinP3.pkl'
...
resGRID = open('ResultadosGRID-SVM/resultadosGRID_joinP3.txt', 'w')
resGRID.flush()
...
joblib.dump(grid.best_estimator_.named_steps['tfidf'], 'Vocab-TFIDFs-SVM/tfidf_model_joinP3.pkl', compress = 1)
